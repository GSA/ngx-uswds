 ...
 *
 * The ESLint migration intentionally warn-first'd a large amount of
 * pre-existing lint debt rather than blocking on it immediately.
 ...
 *
 * Where <workspace> is a key in eslint-baseline.json (e.g. "uswds-components")
...
try {
  ...
  console.error('  Run `ng lint --format json --output-file <path>` first to generate it.');
  process.exit(1);
}
