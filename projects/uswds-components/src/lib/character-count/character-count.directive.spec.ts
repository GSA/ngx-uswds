...
xdescribe('CharacterCountDirective', () => {
  ...
  it('should display character counter text', () => {
    const characterCountMessage =
      component.elementRef.nativeElement.querySelector(`.${MESSAGE_CLASS}`);
  ...
  it('should update text when users go over limit', () => {
    ...
    const characterCountMessage: HTMLElement =
      component.elementRef.nativeElement.querySelector(`.${MESSAGE_CLASS}`);
  ...
  it('should update text for form control inputs', () => {
    ...
    const characterCountMessage: HTMLElement =
      component.elementRef.nativeElement.querySelectorAll(
        `.${MESSAGE_CLASS}`
      )[1];
