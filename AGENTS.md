...
- Unit tests: `npm run test` or `npm run test:components`
...
- GitHub Actions CI runs `npm ci`, `npm run build:components`, builds Storybook, then runs `npm run test:components`.
